...
public class Prompt {
    ...
    public final static String PERSONAL_STATEMENT_PROMPT_TIRED = "\n이 대화 내역과 추천받은 직업을 바탕으로 자기소개서를 작성할건데 규칙이 있어.\n" +
            ...
            "두번째 항목은 '성장 배경' 을 적어줘\n" +
            "[예시]\n성장배경\n 저는 56세 남성 김수민입니다. 저는 대한대학교 사회복지학과를 전공하였으며, 지난 10년간 사회복지센터에서 사무직으로 근무한 경험이 있습니다. 이러한 경험은 제가 사회복지 분야에서 일하는 데 있어 중요한 밑거름이 되었습니다.\n" +
            "\n" +
            ...
            "항목의 맨 앞에는 무조건 '# '을 붙이고 항목의 맨 뒤에는 무조건 <br/> 을 붙이고 항목의 내용이 끝나면 무조건 <br/>를 붙여서 구분지어" +
